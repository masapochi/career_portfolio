            ...
            <div class="row gy-4 justify-content-center">
              @foreach($services as $service)
                <section class="col-md-6 col-lg-4 text-center">
                  <figure class="px-3 px-md-3 px-lg-0">
                    <img class="img-fluid rounded shadow-sm" src="{{ asset("./images/{$service->file}") }}" alt="{{ $service->label }} {{ $service->desc }}" width="" height="" loading="lazy" decoding="async">
                  </figure>
                  <h1 class="h5 fw-bold font-serif">{{ $service->label }}</h1>
                  <p class="text-secondary fs-6">{{ $service->desc }}</p>
                </section>
              @endforeach
            </div>
          </div>
            ...
            <div class="row g-5">
              @foreach($works as $work)
                <section class="col-md-6">
                  <figure class="">
                    <img class="img-fluid rounded shadow-sm" src="{{ asset("./images/{$work->image}") }}" alt="{{ $work->title }}" width="1206" height="630" loading="lazy" decoding="async">
                  </figure>
                  <div class="">
                    <h1 class="h5 fw-bold font-serif">{{ $work->title }}</h1>
                    <p>{{ $work->desc }}</p>
                    @if($work->href)
                      <a class="btn btn-sm btn-outline-primary" href="{{ $work->href }}" target="_blank" rel="noopener">
                    ...
                    @if($work->git)
                      <a class="btn btn-sm btn-outline-primary" href="{{ $work->git }}" target="_blank" rel="noopener">
          ...
          <section class="col-xl-8 px-xl-0">
            <div class="row g-5">
              <div class="profile col-lg-5">
                ...
                <h1 class="h2 text-center fw-bolder mb-4">Masapochi</h1>
              ...
              <div class="biography col-lg-7">
                <p>フロント・バックエンドエンジニア、UI/UXデザイナー</p>
                ...
                <div class="row g-5">
                  <div class="col-12">
                    <h3 class="h5 fw-bold font-serif border-bottom">Career</h3>
                    <div class="row">
                      <ul class="col-md-6 px-5">
                        <li>WEBアプリ開発</li>
                        <li>社内ツール開発</li>
                        <li>UI/UXデザイン</li>
                        <li>ランディングページ作成</li>
                  ...
                  <div class="col-md-6">
                    <h3 class="h5 fw-bold font-serif border-bottom">Interests</h3>
                    <ul>
                      <li>コーヒー</li>
                      <li>ガジェット</li>
                      <li>筋トレ</li>
                  ...
                  <div class="col-md-6">
                    <h3 class="h5 fw-bold font-serif border-bottom">Education</h3>
                    <ul>
                      <li>外国語大学卒業</li>
                    </ul>
                  </div>
            ...
            <div class="row g-5">
              @foreach($skills as $skill)
                <section class="col-6 col-md-4 text-center">
                  ...
                  <p class="text-secondary fs-6">{!! $skill->detail !!}</p>
                </section>
              @endforeach
            </div>
          </div>
          ...
          <form class="col-xl-8 px-xl-0">
            <div class="row gx-5 gy-3">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control form-control-lg" id="inputMessage" rows="3"></textarea>
              </div>
              <div class="col-12">
